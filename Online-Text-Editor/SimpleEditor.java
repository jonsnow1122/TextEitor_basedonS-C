                ...
                if (input != null) {
                    ...
                    if (sizeTokens.length == 2) {
                        try {
                            ...
                            if (width > 0 && height > 0) {
                                String imagePath = "F:\\QQ图片20230701090251.png";
                                ImageIcon selectedImage = new ImageIcon(imagePath);
                                Image image = selectedImage.getImage();
                                System.err.println("width2:" + width);
                                System.err.println("height2:" + height);
                                ...
                                textPane.getStyledDocument().setCharacterAttributes(textPane.getSelectionStart(),
                                        textPane.getSelectionEnd() - textPane.getSelectionStart(), attrs, true);
                            } else {
